...
void clause_theory_solver::set_initial_watches(clause * cl)
{
...
void clause_theory_solver::check_clauses(const std::vector<clause *> & clauses)
{
...
void clause_theory_solver::explain_literal(const expression & l)
{
  ...
  std::cout << "CLAUSE THEORY SOLVER - EXPLAIN LITERAL" << std::endl;
  std::cout << "Njegovo objasnjenje je ";
  reason_clause->print_clause(std::cout);
  std::cout << std::endl;
